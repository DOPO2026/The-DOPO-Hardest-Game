...
public class ConstructorNivel {
    ...
    public Nivel construirDesdeArchivo(String rutaArchivo) {
        if (rutaArchivo == null || rutaArchivo.isBlank()) {
            throw TheDopoHardestGameException.rutaVacia();
        }
        try (BufferedReader br = new BufferedReader(new FileReader(rutaArchivo))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                try {
                    ...
                    throw TheDopoHardestGameException.lineaInvalidaMetadata(linea);
                }
            }
            ...
            try (BufferedReader br2 = new BufferedReader(new FileReader(rutaArchivo))) {
                while ((linea = br2.readLine()) != null) {
                    ...
                    try {
                        ...
                        throw TheDopoHardestGameException.lineaConFormatoInvalido(linea);
                    }
                }
            }
            return nivel;
        } catch (IOException ex) {
            throw TheDopoHardestGameException.nivelNoCargable(rutaArchivo);
        }
    }
    ...
    private void construirZona(String[] t) {
        ...
        switch (tipo) {
            ...
            default           -> throw TheDopoHardestGameException.tipoZonaDesconocido(tipo);
        }
    }
    ...
    private void construirMoneda(String[] t) {
        ...
        if (tipo.equals("AMARILLA")) {
            ...
            Skin skin = switch (color) {
                ...
                case "AZUL"  -> new Inky();
                default      -> throw TheDopoHardestGameException.colorSkinDesconocido(color);
            };
            nivel.agregarMoneda(new MonedaSkin(x, y, TAM_MONEDA, TAM_MONEDA, skin));
        } else {
            throw TheDopoHardestGameException.tipoMonedaDesconocido(tipo);
        }
    }
    ...
    private void construirElemento(String[] t) {
        ...
        switch (tipo) {
            ...
            default       -> throw TheDopoHardestGameException.elementoDesconocido(tipo);
        }
    }
