...
class AITest {
    ...
    @Test
    void maquinaAleatoriaRetornaDireccionEnPrimerLlamado() {
        Direction d = new MaquinaAleatoria().decidirMovimiento(nivel());
        assertNotNull(d);
    }

    @Test
    void maquinaAleatoriaMantieneDireccionMientrasTienePasos() {
    ...
    @Test
    void maquinaAleatoriaReeligeDireccionAlAcabarPasos() {
        MaquinaAleatoria m = new MaquinaAleatoria();
        Nivel n = nivel();
    ...
    @Test
    void maquinaExpertaRetornaQuieto() {
