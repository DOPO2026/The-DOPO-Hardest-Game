...
class CollectiblesTest {
    ...
    @Test
    void fuenteDeVidaActivaEscudoUnaVez() {
    ...
    @Test
    void fuenteDeVidaNoActivaDosVeces() {
        FuenteDeVida f = new FuenteDeVida(50, 50, 20, 20);
        Jugador j = jugador();
        f.activar(j);
    ...
    @Test
    void monedaSkinRecolectaYExponesSkin() {
        Inky inky = new Inky();
    ...
    @Test
    void inkyTienePropiedadesCorrectas() {
        Inky inky = new Inky();
