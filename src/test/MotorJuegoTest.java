...
class MotorJuegoTest {
    ...
    @Test
    void monedaSkinAplicaSkinAlJugador() {
        Nivel n = new Nivel("t", 800, 600, 60);
        Jugador j = crearJugadorEn(100, 100);
        n.agregarJugador(j);
    ...
    @Test
    void fuenteDeVidaOtorgaEscudoAlJugador() {
        Nivel n = new Nivel("t", 800, 600, 60);
    ...
    @Test
    void bombaMataaJugadorYReiniciaMonedas() {
        Nivel n = new Nivel("t", 800, 600, 60);
        Jugador j = crearJugadorEn(100, 100);
        n.agregarJugador(j);
    ...
    @Test
    void zonaIntermediaCambiaRespawnDelJugador() {
        Nivel n = new Nivel("t", 800, 600, 60);
    ...
    @Test
    void colisionPvPMataAmbosJugadores() {
        Nivel n = new Nivel("t", 800, 600, 60);
